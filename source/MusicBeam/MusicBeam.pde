...
void setup() {
  surface.setTitle("MusicBeam testEdit Ryan Vrosch :"+version);
...
void initRandomControls() {
  ...
  activeEffect = cp5.addRadioButton("activeEffects").setPosition(415, 115).setSize(250, 35).setItemsPerRow(1).setSpacingRow(5).setNoneSelectedAllowed(true);
  activeSetting = cp5.addRadioButton("activeSettings").setPosition(720, 115).setSize(35, 35).setItemsPerRow(1).setSpacingRow(5);
}
